  ...
  return (
    <footer>
      <div className="contact">
        <h2>Ponte en <span className="text-gradient">Contacto</span></h2>
        ...
        >
          <i className="fa-brands fa-whatsapp" aria-hidden="true"></i> Escribir por WhatsApp
        </a>

        <div className="social">
          <a href="https://www.linkedin.com/in/maikel-garcía-8a3b60232/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
      ...
      <div className="rights">
        Creado por Maikel García - {new Date().getFullYear()}
      </div>
    </footer>
  )
}
